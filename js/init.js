...
function arlo_tm_animate_text() {
  ...
  animateSpan.typed({
    strings: ["a NFT Collection", "a Metaverse Game", "a Cryptocurrency"],
    loop: true,
    startDelay: 1e3,
    backDelay: 2e3,
  });
...
function accordion() {
  // const number = $(".accordion_container").children.length;
  ...
  $(".accordion_item").click(function () {
    ...
    $(this).find(".acc-chevron").toggleClass("active-chevron");
  });
  // }
}
